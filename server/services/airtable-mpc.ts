...
export class AirtableMPCService {
  ...
  constructor() {
    ...
    this.encryptionKeyBuffer = this.generateEncryptionKey();
  }
    ...
    try {
      ...
      if (filters.clientName) {
        results = results.filter(result => 
          result.clientName && result.clientName.toLowerCase().includes(filters.clientName!.toLowerCase())
        );
      }
